...
var screenByteLength;
  ...
  function allocateTeaVMstring(str) {
    ...
    let objectArrayData = instance.exports.teavm_objectArrayData(
  ...
  function processPixels(pixelsPtr) {
    self.postMessage({
        eventType: "FRAME",
        eventData: {
			image: new Uint8Array(instance.exports.memory.buffer, instance.exports.teavm_intArrayData(pixelsPtr), screenByteLength).slice(),
		}
    });
  }
