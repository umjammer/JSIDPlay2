...
public class IniEmulationSection extends IniSection implements IEmulationSection {
	...
	@Override
	@Parameter(names = { "--forceStereoModel" }, descriptionKey = "FORCE_STEREO_MODEL", order = 1006)
	...
	@Override
	@Parameter(names = { "--forceThirdModel" }, descriptionKey = "FORCE_THIRD_MODEL", order = 1007)
	...
	@Override
	@Parameter(names = { "--hardSid6581" }, descriptionKey = "HARDSID_6581", order = 1008)
	...
	@Override
	@Parameter(names = { "--hardSid8580" }, descriptionKey = "HARDSID_8580", order = 1009)
	...
	public final boolean isSidBlasterRead() {
		return iniReader.getPropertyBool(SECTION_ID, "SIDBlasterRead", DEFAULT_SIDBLASTER_READ);
	}

	@Override
	@Parameter(names = { "--sidBlasterRead" }, descriptionKey = "SIDBLASTER_READ", arity = 1, order = 1010)
	public final void setSidBlasterRead(final boolean sidBlasterRead) {
		iniReader.setProperty(SECTION_ID, "SIDBlasterRead", sidBlasterRead);
	}

	@Override
	public final short getSidBlasterLatencyTimer() {
		return iniReader.getPropertyShort(SECTION_ID, "SIDBlasterLatencyTimer", DEFAULT_SIDBLASTER_LATENCY_TIMER);
	}

	@Override
	@Parameter(names = {
			"--sidBlasterLatencyTimer" }, descriptionKey = "SIDBLASTER_LATENCY_TIMER", converter = ShortConverter.class, validateWith = LatencyTimerValidator.class, arity = 1, order = 1011)
	...
	@Override
	@Parameter(names = { "--exsidFakeStereo" }, descriptionKey = "EXSID_FAKE_STEREO", arity = 1, order = 1012)
	...
	@Override
	@Parameter(names = { "--NetSIDDevHost" }, descriptionKey = "NET_SID_DEV_HOST", order = 1013)
	...
	@Override
	@Parameter(names = { "--NetSIDDevPort" }, descriptionKey = "NET_SID_DEV_PORT", order = 1014)
	...
	@Override
	@Parameter(names = { "--ultimate64Mode" }, descriptionKey = "ULTIMATE64_MODE", order = 1015)
	...
	@Override
	@Parameter(names = { "--Ultimate64Host" }, descriptionKey = "ULTIMATE64_HOST", order = 1016)
	...
	@Override
	@Parameter(names = { "--Ultimate64Port" }, descriptionKey = "ULTIMATE64_PORT", order = 1017)
	...
	@Override
	@Parameter(names = { "--Ultimate64SyncDelay" }, descriptionKey = "ULTIMATE64_SYNC_DELAY", order = 1018)
	...
	@Parameter(names = { "--disableFilter",
			"-i" }, descriptionKey = "DISABLE_FILTER", arity = 1, converter = NegatedBooleanConverter.class, order = 1019)
	...
	@Parameter(names = { "--disableStereoFilter",
			"-j" }, descriptionKey = "DISABLE_STEREO_FILTER", arity = 1, converter = NegatedBooleanConverter.class, order = 1020)
	...
	@Parameter(names = { "--disable3rdSidFilter",
			"-J" }, descriptionKey = "DISABLE_3RD_SID_FILTER", arity = 1, converter = NegatedBooleanConverter.class, order = 1021)
	...
	@Override
	@Parameter(names = { "--sidToRead" }, descriptionKey = "SID_TO_READ", order = 1022)
	...
	@Override
	@Parameter(names = { "--digiBoosted8580" }, descriptionKey = "DIGIBOOSTED8580", arity = 1, order = 1023)
	...
	@Override
	@Parameter(names = { "--dualSIDBase" }, descriptionKey = "DUAL_SID_BASE", arity = 1, order = 1024)
	...
	@Override
	@Parameter(names = { "--thirdSIDBase" }, descriptionKey = "THIRD_SID_BASE", arity = 1, order = 1025)
	...
	@Override
	@Parameter(names = { "--fakeStereo" }, descriptionKey = "FAKE_STEREO", arity = 1, order = 1026)
	...
	@Override
	@Parameter(names = { "--dualSID", "-d" }, descriptionKey = "DUAL_SID", arity = 1, order = 1027)
	...
	@Override
	@Parameter(names = { "--thirdSID", "-D" }, descriptionKey = "THIRD_SID", arity = 1, order = 1028)
	...
	@Override
	@Parameter(names = { "--muteVoice1", "-1" }, descriptionKey = "MUTE_VOICE_1", arity = 1, order = 1029)
	...
	@Override
	@Parameter(names = { "--muteVoice2", "-2" }, descriptionKey = "MUTE_VOICE_2", arity = 1, order = 1030)
	...
	@Override
	@Parameter(names = { "--muteVoice3", "-3" }, descriptionKey = "MUTE_VOICE_3", arity = 1, order = 1031)
	...
	@Override
	@Parameter(names = { "--muteVoice4", "-4" }, descriptionKey = "MUTE_VOICE_4", arity = 1, order = 1032)
	...
	@Override
	@Parameter(names = { "--muteStereoVoice1", "-5" }, descriptionKey = "MUTE_VOICE_5", arity = 1, order = 1033)
	...
	@Override
	@Parameter(names = { "--muteStereoVoice2", "-6" }, descriptionKey = "MUTE_VOICE_6", arity = 1, order = 1034)
	...
	@Override
	@Parameter(names = { "--muteStereoVoice3", "-7" }, descriptionKey = "MUTE_VOICE_7", arity = 1, order = 1035)
	...
	@Override
	@Parameter(names = { "--muteStereoVoice4", "-8" }, descriptionKey = "MUTE_VOICE_8", arity = 1, order = 1036)
	...
	@Override
	@Parameter(names = { "--muteThirdSidVoice1", "-9" }, descriptionKey = "MUTE_VOICE_9", arity = 1, order = 1037)
	...
	@Override
	@Parameter(names = { "--muteThirdSidVoice2" }, descriptionKey = "MUTE_VOICE_10", arity = 1, order = 1038)
	...
	@Override
	@Parameter(names = { "--muteThirdSidVoice3" }, descriptionKey = "MUTE_VOICE_11", arity = 1, order = 1039)
	...
	@Override
	@Parameter(names = { "--muteThirdSidVoice4" }, descriptionKey = "MUTE_VOICE_12", arity = 1, order = 1040)
	...
	@Override
	@Parameter(names = {
			"--filter6581" }, descriptionKey = "FILTER_6581", validateWith = ReSidFilter6581Validator.class, order = 1041)
	...
	@Override
	@Parameter(names = {
			"--stereoFilter6581" }, descriptionKey = "STEREO_FILTER_6581", validateWith = ReSidFilter6581Validator.class, order = 1042)
	...
	@Override
	@Parameter(names = {
			"--thirdFilter6581" }, descriptionKey = "THIRD_FILTER_6581", validateWith = ReSidFilter6581Validator.class, order = 1043)
	...
	@Override
	@Parameter(names = {
			"--filter8580" }, descriptionKey = "FILTER_8580", validateWith = ReSidFilter8580Validator.class, order = 1044)
	...
	@Override
	@Parameter(names = {
			"--stereoFilter8580" }, descriptionKey = "STEREO_FILTER_8580", validateWith = ReSidFilter8580Validator.class, order = 1045)
	...
	@Override
	@Parameter(names = {
			"--thirdFilter8580" }, descriptionKey = "THIRD_FILTER_8580", validateWith = ReSidFilter8580Validator.class, order = 1046)
	...
	@Override
	@Parameter(names = {
			"--reSIDfpFilter6581" }, descriptionKey = "RESIDFP_FILTER_6581", validateWith = ReSidFpFilter6581Validator.class, order = 1047)
	...
	@Override
	@Parameter(names = {
			"--reSIDfpStereoFilter6581" }, descriptionKey = "RESIDFP_STEREO_FILTER_6581", validateWith = ReSidFpFilter6581Validator.class, order = 1048)
	...
	@Override
	@Parameter(names = {
			"--reSIDfpThirdFilter6581" }, descriptionKey = "RESIDFP_THIRD_FILTER_6581", validateWith = ReSidFpFilter6581Validator.class, order = 1049)
	...
	@Override
	@Parameter(names = {
			"--reSIDfpFilter8580" }, descriptionKey = "RESIDFP_FILTER_8580", validateWith = ReSidFpFilter8580Validator.class, order = 1050)
	...
	@Override
	@Parameter(names = {
			"--reSIDfpStereoFilter8580" }, descriptionKey = "RESIDFP_STEREO_FILTER_8580", validateWith = ReSidFpFilter8580Validator.class, order = 1051)
	...
	@Override
	@Parameter(names = {
			"--reSIDfpThirdFilter8580" }, descriptionKey = "RESIDFP_THIRD_FILTER_8580", validateWith = ReSidFpFilter8580Validator.class, order = 1052)
	...
	@Override
	@Parameter(names = {
			"--detectPSID64ChipModel" }, descriptionKey = "DETECT_PSID64_CHIP_MODEL", arity = 1, order = 1053)
