...
public class IniEmulationSection extends IniSection implements IEmulationSection {
	...
	@Override
	@Parameter(names = { "--forceEmulation" }, descriptionKey = "FORCE_EMULATION", order = 1002)
	...
	@Override
	@Parameter(names = { "--forceStereoEmulation" }, descriptionKey = "FORCE_STEREO_EMULATION", order = 1003)
	...
	@Override
	@Parameter(names = { "--forceThirdEmulation" }, descriptionKey = "FORCE_THIRD_EMULATION", order = 1004)
	...
	@Override
	@Parameter(names = { "--defaultClock", "-k" }, descriptionKey = "DEFAULT_CLOCK", order = 1005)
	...
	@Override
	@Parameter(names = { "--forceClock", "-c" }, descriptionKey = "FORCE_CLOCK", order = 1006)
	...
	@Override
	@Parameter(names = { "--defaultModel", "-u" }, descriptionKey = "DEFAULT_MODEL", order = 1007)
	...
	@Override
	@Parameter(names = { "--forceModel", "-m" }, descriptionKey = "FORCE_MODEL", order = 1008)
	...
	@Override
	@Parameter(names = { "--forceStereoModel" }, descriptionKey = "FORCE_STEREO_MODEL", order = 1009)
	...
	@Override
	@Parameter(names = { "--forceThirdModel" }, descriptionKey = "FORCE_THIRD_MODEL", order = 1010)
	...
	@Override
	@Parameter(names = {
			"--sidBlasterLatencyTimer" }, descriptionKey = "SIDBLASTER_LATENCY_TIMER", converter = ShortConverter.class, validateWith = LatencyTimerValidator.class, arity = 1, order = 1014)
	...
	@Parameter(names = { "--disableFilter",
			"-i" }, descriptionKey = "DISABLE_FILTER", arity = 1, converter = NegatedBooleanConverter.class, order = 1022)
	...
	@Parameter(names = { "--disableStereoFilter",
			"-j" }, descriptionKey = "DISABLE_STEREO_FILTER", arity = 1, converter = NegatedBooleanConverter.class, order = 1023)
	...
	@Parameter(names = { "--disable3rdSidFilter",
			"-J" }, descriptionKey = "DISABLE_3RD_SID_FILTER", arity = 1, converter = NegatedBooleanConverter.class, order = 1024)
	...
	@Override
	@Parameter(names = { "--dualSIDBase" }, descriptionKey = "DUAL_SID_BASE", arity = 1, order = 1027)
	...
	@Override
	@Parameter(names = { "--dualSID", "-d" }, descriptionKey = "DUAL_SID", arity = 1, order = 1030)
	...
	@Override
	@Parameter(names = { "--thirdSID", "-D" }, descriptionKey = "THIRD_SID", arity = 1, order = 1031)
	...
	@Override
	@Parameter(names = { "--muteThirdSidVoice1", "-9" }, descriptionKey = "MUTE_VOICE_9", arity = 1, order = 1040)
	...
	@Override
	@Parameter(names = { "--muteThirdSidVoice2" }, descriptionKey = "MUTE_VOICE_10", arity = 1, order = 1041)
	...
	@Override
	@Parameter(names = { "--muteThirdSidVoice3" }, descriptionKey = "MUTE_VOICE_11", arity = 1, order = 1042)
	...
	@Override
	@Parameter(names = { "--muteThirdSidVoice4" }, descriptionKey = "MUTE_VOICE_12", arity = 1, order = 1043)
	...
	@Override
	@Parameter(names = {
			"--filter6581" }, descriptionKey = "FILTER_6581", validateWith = ReSidFilter6581Validator.class, order = 1044)
	...
	@Override
	@Parameter(names = {
			"--stereoFilter6581" }, descriptionKey = "STEREO_FILTER_6581", validateWith = ReSidFilter6581Validator.class, order = 1045)
	...
	@Override
	@Parameter(names = {
			"--thirdFilter6581" }, descriptionKey = "THIRD_FILTER_6581", validateWith = ReSidFilter6581Validator.class, order = 1046)
	...
	@Override
	@Parameter(names = {
			"--filter8580" }, descriptionKey = "FILTER_8580", validateWith = ReSidFilter8580Validator.class, order = 1047)
	...
	@Override
	@Parameter(names = {
			"--stereoFilter8580" }, descriptionKey = "STEREO_FILTER_8580", validateWith = ReSidFilter8580Validator.class, order = 1048)
	...
	@Override
	@Parameter(names = {
			"--thirdFilter8580" }, descriptionKey = "THIRD_FILTER_8580", validateWith = ReSidFilter8580Validator.class, order = 1049)
	...
	@Override
	@Parameter(names = {
			"--reSIDfpFilter6581" }, descriptionKey = "RESIDFP_FILTER_6581", validateWith = ReSidFpFilter6581Validator.class, order = 1050)
	...
	@Override
	@Parameter(names = {
			"--reSIDfpStereoFilter6581" }, descriptionKey = "RESIDFP_STEREO_FILTER_6581", validateWith = ReSidFpFilter6581Validator.class, order = 1051)
	...
	@Override
	@Parameter(names = {
			"--reSIDfpThirdFilter6581" }, descriptionKey = "RESIDFP_THIRD_FILTER_6581", validateWith = ReSidFpFilter6581Validator.class, order = 1052)
	...
	@Override
	@Parameter(names = {
			"--reSIDfpFilter8580" }, descriptionKey = "RESIDFP_FILTER_8580", validateWith = ReSidFpFilter8580Validator.class, order = 1053)
	...
	@Override
	@Parameter(names = {
			"--reSIDfpStereoFilter8580" }, descriptionKey = "RESIDFP_STEREO_FILTER_8580", validateWith = ReSidFpFilter8580Validator.class, order = 1054)
	...
	@Override
	@Parameter(names = {
			"--reSIDfpThirdFilter8580" }, descriptionKey = "RESIDFP_THIRD_FILTER_8580", validateWith = ReSidFpFilter8580Validator.class, order = 1055)
	...
	@Override
	@Parameter(names = {
			"--detectPSID64ChipModel" }, descriptionKey = "DETECT_PSID64_CHIP_MODEL", arity = 1, order = 1056)
