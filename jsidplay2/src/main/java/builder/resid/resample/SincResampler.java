...
public final class SincResampler implements Resampler {
	...
	public SincResampler(final double clockFrequency, final double samplingFrequency,
...

		{
			...
			if (firN > RINGSIZE - 1) {
				throw new RuntimeException(
						String.format("Resampling quality exceeds the available buffer: %d required, but only has %d",
								firN, RINGSIZE));
			}
		...
		// The cutoff frequency is midway through the transition band, in effect
		// the same as nyquist.
