...
public final class WaveformCalculator {
	...
	private static final CombinedWaveformConfig wfconfig[][] = new CombinedWaveformConfig[][] { { /*
			...
			{ /* kevtris chip V (8580) */
					...
					new CombinedWaveformConfig(0.9097769f, 2.039997f, 0.9584096f, 0.1765447f, 0f), // error
																									// 18763
					new CombinedWaveformConfig(0.9231212f, 2.084788f, 0.9493895f, 0.1712518f, 0f), // error
																									// 17103
					new CombinedWaveformConfig(0.9845552f, 1.415612f, 0.9703883f, 3.68829f, 0.8265008f), // error
																											// 3319
					new CombinedWaveformConfig(0.5f, 0.0f, 1.0f, 0.0f, 0.0f), }, };
	...
	private static void fillInWaveformSample(final float[] o, ChipModel model, int waveform, int accumulator, int pw) {
		...
		final CombinedWaveformConfig config = wfconfig[model == ChipModel.MOS6581 ? 0 : 1][waveform == 3 ? 0
				: waveform == 5 ? 1 : waveform == 6 ? 2 : waveform == 7 ? 3 : 4];
