...
public class SFXSoundExpander {
	...
	private int sfx_soundexpander_sound_machine_init(int speed, int cycles_per_sec) {
...
//		snd.command = 0;
	...
	private int sfx_soundexpander_sound_machine_calculate_samples(int[] pbuf, int nr, int soc, int scc, int[] delta_t) {
	...
	private void sfx_soundexpander_sound_machine_close() {
		if (YM3526_chip != null) {
			fmOpl.ym3526_shutdown(YM3526_chip);
			YM3526_chip = null;
		}
	...
	private void sfx_soundexpander_sound_machine_store(int addr, int val) {
//	    snd.command = val;
	...
	private int sfx_soundexpander_sound_machine_read(int addr) {
		if (sfx_soundexpander_chip == 3812 && YM3812_chip != null) {
	...
	private void sfx_soundexpander_sound_reset(CPUClock cpu_clk) {
		if (sfx_soundexpander_chip == 3812 && YM3812_chip != null) {
