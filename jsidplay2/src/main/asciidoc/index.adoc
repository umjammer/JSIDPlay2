...
* This demo version streams content from my server to the browser ...

link:https://haendel.ddns.net:8443/static/c64jukebox.vue[JSIDPlay2 - restful API^]

* ... whilst that demo version can play tunes directly in the browser (alpha version)

link:https://haendel.ddns.net:8443/static/c64jukebox-wasm.vue[JSIDPlay2 - Web Assembly^]
