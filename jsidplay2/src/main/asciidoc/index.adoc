...
Java is required and must be installed separately. You can choose to install OpenJDK or as an alternative Oracle JDK
|===
...
This being said, you can use JSIDPlay2 using Oracle Java 8 and separate start scrips with *java8* in its name.
...
Or as an alternative, you can choose OpenJDK or Oracle Java Java 17 or never.
...
The android app has been replaced by a HTML5 web version called  link:https://haendel.ddns.net:8443/static/c64jukebox.vue[C64Jukebox])
