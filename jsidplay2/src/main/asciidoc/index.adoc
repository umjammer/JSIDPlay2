...
*Compatibility Note*: Runs in Google Chrome, Firefox, Microsoft Edge, Opera browser and Apple's Safari.
...
*Compatibility Note*: Runs in Google Chrome, Microsoft Edge and Opera browser.
Does not run in Firefox. Apple's Safari browser still untested.
