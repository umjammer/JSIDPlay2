...
*Note:* If you have a modern Apple computer and get trouble launching JSIDPlay2 on your machine,
please try a Java Runtime, where JavaFX is already bundled with.
For example link:https://bell-sw.com/pages/downloads/[https://bell-sw.com/pages/downloads/^]
...
JSIDPlay2 for Java 8, 11, 17, 21, ...
|===
| *Architecture* | *x86_64*                                                       | *aarm64*
