...
* link:https://haendel.ddns.net:8443/static/teavm/wasm/c64jukebox.vue[The second demo site^] can play tunes directly in the browser (web assembly alpha version)

* link:https://haendel.ddns.net:8443/static/teavm/js/c64jukebox.vue[The third demo site^] can play tunes directly in the browser (javascript alpha version)
