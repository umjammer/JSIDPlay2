...
. ...and this demo runs directly in the browser as well but using JavaScript link:https://haendel.ddns.net:8443/static/teavm/c64jukebox.vue?teavmFormat=JS_EM2015[C64jukebox - using JavaScript EM2015^]
