...
|===
| | JSIDPlay2 for Java 8 | JSIDPlay2 for Java 11, 17, ...
...
== JSIDPlay2 Server
link:https://haendel.ddns.net:8443[JSIDPlay2 Server API Documentation^]

link:https://haendel.ddns.net:8443/static/c64jukebox.vue[Example Client: JSIDPlay2 Online Player^]

link:https://haendel.ddns.net:8443/static/whatssid.vue[Example Client: WhatsSID? Tune Recognition^]
