...
=== JSIDPlay2 - RESTful service endpoints
...
link:{protocol}://{hostname}:{port}/jsidplay2service/JSIDPlay2REST/stil[Usage]
...
link:{protocol}://{hostname}:{port}/jsidplay2service/JSIDPlay2REST/disk-directory[Usage]
...
link:{protocol}://{hostname}:{port}/jsidplay2service/JSIDPlay2REST/upload[Usage]
...
link:{protocol}://{hostname}:{port}/jsidplay2service/JSIDPlay2REST/hardsid-mapping[Usage]
...
link:{protocol}://{hostname}:{port}/jsidplay2service/JSIDPlay2REST/exsid-mapping[Usage]
...
link:{protocol}://{hostname}:{port}/jsidplay2service/JSIDPlay2REST/sidblaster-mapping[Usage]
...
link:{protocol}://{hostname}:{port}/static/insert_next_cart[Usage]
...
link:{protocol}://{hostname}:{port}/static/insert_next_disk[Usage]
...
link:{protocol}://{hostname}:{port}/static/joystick[Usage]
...
link:{protocol}://{hostname}:{port}/static/press_key[Usage]
